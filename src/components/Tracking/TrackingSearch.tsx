...
const TrackingSearch = () => {
    ...
    return (
      <div className="flex flex-col h-screen gap-0">
        ...
        {/* Main Content */}
        <div className="flex flex-grow h-screen gap-7"> {/* Ensure the parent div takes full height */}
            <div className="hidden lg:block w-1/2 bg-gradient-to-b from-[#005f6a] to-[#016a75] h-full"> {/* Use h-full to take full height of parent */}
            ...
            <div className="flex-1 flex flex-col justify-start mt-12 p-6 bg-white">
                <div className="mb-6 flex-col space-y-9">
                    <div className='space-y-5'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" className="ml-7 lucide lucide-search-slash text-[#005f6a]">
                            <path d="m14.5 10-7 3" stroke="red"/> {/* Change the color of the stroke line inside the circle */}
                            <circle cx="11" cy="11" r="8" stroke="currentColor"/> {/* Use currentColor for the rest of the circle */}
                    ...
                    <div className="">
                        ...
                        <button className="mt-6 px-8 font-bold py-4 fixed right-24 bg-[#005f6a] text-white rounded-md hover:bg-[#005f6a]">
                            Search
                        </button>
                    </div>
                </div>
